...
// Publisher
//
// pub fn validate_publisher_delete(_op: &Op, _entry: PublisherEntry) -> ExternResult<ValidateCallbackResult> {
...
// App
//
// pub fn validate_app_delete(_op: &Op, _entry: AppEntry) -> ExternResult<ValidateCallbackResult> {
//     Ok(ValidateCallbackResult::Valid)
// }
